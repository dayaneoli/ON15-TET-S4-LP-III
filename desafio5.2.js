...
// let cliente1 = data.find((elemento) => elemento.genero == "suspense");
// console.log(cliente1); 
 

// //busca cliente5 = "romance" 
// let cliente5 = data.find((elemento) => elemento.genero.includes("romance"));
...
function buscarPorTitulo(entrada) {
    ...
    data.forEach(filme => {
        let titulo = filme.titulo.toLocaleLowerCase()
...
buscarFilmes("Corpo Elétrico")

buscarFilmes("Homem-Aranha: Sem Volta para Casa")
